<%@ Page Async="true" Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmDeposito.aspx.cs" Inherits="AppWebInternetBanking.Views.frmDeposito" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
 ...
 <script type="text/javascript">
       ...
       function openModal() {
        ...
        $(document).ready(function () { //filtrar el datagridview
            $("#myInput").on("keyup", function () {
                ...
                $("#MainContent_gvDepositos tr").filter(function () {
    ...
    <h1>Mantenimiento de Deposito</h1>
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">Mantenimiento de Deposito</h4>
      </div>
      <div class="modal-body">
